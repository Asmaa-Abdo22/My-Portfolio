...
const SocialIcon = ({ item }) => (
  <a
    ...
    className={`text-xl text-gray-300 ${item.hover} transition-colors`}
  >
    {item.icon}
  </a>
);
        ...
        <div className="relative z-10 max-w-[95%] mx-auto px-6 md:px-12 lg:px-28 pt-24 flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-20">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <motion.div
              ...
              className="text-2xl md:text-3xl font-semibold mb-6 bg-gradient-to-r from-pink-300 via-purple-300 to-blue-400 bg-clip-text text-transparent"
            >
              <TypeAnimation
                sequence={[
                  "Software Engineer",
            ...
            >
              <Link to="/projects">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-3 border border-purple-400/40 text-white rounded-lg font-semibold bg-purple-500/5 hover:bg-purple-500/15 transition flex items-center gap-2 text-sm md:text-base"
                >
                  View My Work
                </motion.button>
              </Link>
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-5 py-2 border-2 border-purple-500/50 text-white rounded-lg font-semibold hover:bg-purple-500/10 transition flex items-center gap-2 text-sm md:text-base"
              >
      ...
      >
        <section className="px-6 md:px-12 lg:px-28">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Explore 33+ projects showcasing my skills in modern web
